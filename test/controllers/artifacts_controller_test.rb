...
class ArtifactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artifact" do
    assert_difference("Artifact.count") do
      post artifacts_url, params: { artifact: { description: @artifact.description, name: @artifact.name } }
    end
  ...
  test "should update artifact" do
    patch artifact_url(@artifact), params: { artifact: { description: @artifact.description, name: @artifact.name } }
